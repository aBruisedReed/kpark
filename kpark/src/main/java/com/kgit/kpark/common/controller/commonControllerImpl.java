...
public class commonControllerImpl implements commonController {
	...
	@Override
	@RequestMapping(value = "/common/empty.do", method = RequestMethod.POST)
	...
	@Override
	@RequestMapping(value = "/common/footer.do", method = RequestMethod.POST)
	...
	@Override
	@RequestMapping(value = "/common/header.do", method = RequestMethod.POST)
	...
	@Override
	@RequestMapping(value = "/common/helpCenter.do", method = RequestMethod.POST)
	...
	@Override
	@RequestMapping(value = "/common/layout_only.do", method = RequestMethod.POST)
	...
	@Override
	@RequestMapping(value = "/common/layout.do", method = RequestMethod.POST)
	...
	@Override
	@RequestMapping(value = "/common/main.do", method = RequestMethod.POST)
	...
	@Override
	@RequestMapping(value = "/common/sidebar.do", method = RequestMethod.POST)
