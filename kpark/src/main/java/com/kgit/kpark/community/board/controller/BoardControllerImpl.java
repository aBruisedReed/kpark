...
public class BoardControllerImpl  implements BoardController{
	...
	@ResponseBody
	public ResponseEntity board_addNewArticle(MultipartHttpServletRequest multipartRequest, 
  ...
  public ResponseEntity board_removeArticle(@RequestParam("articleNO") int articleNO,
	...
	@RequestMapping(value = "/community/board/*Form.do", method =  RequestMethod.GET)
