...
import com.kgit.kpark.sell.goods.controller.SellsController;
...
public class SellsControllerImpl implements SellsController {
	private static final Logger logger = LoggerFactory.getLogger(SellsControllerImpl.class);
