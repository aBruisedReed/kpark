...
<head>
	<meta charset="UTF-8">
	<title>관심 차량</title>
	<link rel="stylesheet" href="${contextPath }/resources/css/favoriteCar.css">
...
<body>
	<div id="all">
		<div id="title">
			<p><input type="checkbox" id="checkAll">관심 차량 <span>2</span>대</p><hr>
		</div>
		<!-- for문 이용 동적 구현 -->
		<div class="object">
			...
			<div class="explain_div">
				<a href="#"><p class="car_title">현대 쏘나타 LF쏘나타 1.7디젤 케어플러스</p></a>
