...
<article class="cont">
            ...
            <article class="cont" id="anchor01">
                ...
                <form name="form1" id="form1" action="${contextPath }/buy/buyCounsel2.do" method="get">
...
<!--                                             </select> -->
                                    ...
                                    <tr>
                                        ...
                                        <td class="left">
                                            <select class="select_ty w1" name="YYMM" id="YYMM">
                        ...
                        <div class="table_notice02">
                            ...
                            <div class="info">
                                ...
                                <ul>
                                    ...
                                    <li class="chk_on">
                                        <div class="ez-radio ez-selected"><input type="radio" name="chk_agree" class="chk_ty ez-hide" id="chk_agree02" checked="checked" ></div>
...
<!--                             <a href="#" onclick="addConsulting(); return false;" class="btn_m btn_ty btn_max">신청하기</a> -->
						<button class="btn_m btn_ty btn_max" id="btn11" type="submit">신청하기</button>
