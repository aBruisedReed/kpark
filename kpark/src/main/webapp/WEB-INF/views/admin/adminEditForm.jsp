...
<body>
 ...
 <div class="wrap">
 <div class="edit">
 <form id="editForm" action="${contextPath }/admin/updateMember.do" method="POST">
 <label><h1>회원정보 수정</h1></label>
 <br><br>
 <label class="title">아이디</label>
 <br><br>
 <label class="id"><input type="text" name="user_id" value="${member.user_id }" readonly="readonly" style="background-color: #EAEAEA"></label>
  <br>
 <label class="title">비밀번호 변경</label>
 <br><br>
 <input class="pwd" id="old_pw" type="password" name="old_pw" placeholder="현재 비밀번호" value="${member.user_pw }" readonly="readonly" style="background-color: #EAEAEA">
 <br>
 <input type="password" id="pw1" placeholder="새로운 비밀번호" value="${member.user_pw }" >
 <br>
 <input type="password" id="pw2" name="user_pw"  placeholder="새로운 비밀번호 확인" value="${member.user_pw }">
 <br><br>
 <label class="title">이름</label>
 <br><br>
 <label><input type="text" name="user_name" value="${member.user_name }"></label>
 <br><br>
